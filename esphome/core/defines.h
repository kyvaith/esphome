...
#ifdef USE_ESP32
#define CONFIG_ESPHOME_DSI_CACHE_READ_QOS 0
#define CONFIG_ESPHOME_DSI_CACHE_WRITE_QOS 0
#define CONFIG_ESPHOME_DSI_CPU_READ_QOS 0
#define CONFIG_ESPHOME_DSI_CPU_WRITE_QOS 0
#define CONFIG_ESPHOME_DSI_GDMA_READ_QOS 0
#define CONFIG_ESPHOME_DSI_GDMA_WRITE_QOS 0
#define CONFIG_ESPHOME_JPEG_DECODER_DIRECT_PSRAM_INPUT 1
