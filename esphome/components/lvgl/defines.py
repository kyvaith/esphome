...
LV_CHART_TYPES = (
    ...
    "BAR",
    "SCATTER",
    "CURVE",  # LVGL 9.5: Bezier curved charts (requires Vector Graphics/ThorVG)
)
LV_CHART_AXES = (
    "PRIMARY_Y",
    "SECONDARY_Y",
...
LV_DEFINES = (
    ...
    "LV_USE_SYSMON", "LV_USE_PERF_MONITOR", "LV_USE_PERF_MONITOR_POS",
    "LV_USE_PERF_MONITOR_LOG_MODE", "LV_USE_PROFILER",
    "LV_USE_PROFILER_BUILTIN", "LV_USE_PROFILER_BUILTIN_POSIX",
    "LV_PROFILER_BUILTIN_BUF_SIZE", "LV_PROFILER_BUILTIN_DEFAULT_ENABLE",
