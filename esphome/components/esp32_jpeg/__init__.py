    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_DMA2D_AXI_BURSTINESS, default=8): cv.int_range(min=0, max=15),
            cv.Optional(CONF_DMA2D_PEAK_LEVEL, default=0): cv.int_range(min=0, max=15),
            cv.Optional(CONF_DMA2D_TRANSACTION_LEVEL, default=1): cv.int_range(min=0, max=15),
            ...
            cv.Optional(CONF_JPEG_DMA2D_AXI_BURSTINESS, default=1): cv.int_range(min=0, max=15),
            cv.Optional(CONF_JPEG_DMA2D_PEAK_LEVEL, default=2): cv.int_range(min=0, max=15),
            cv.Optional(CONF_JPEG_DMA2D_TRANSACTION_LEVEL, default=4): cv.int_range(min=0, max=15),
